...
(*TODO: Reformulate the colimOverFinsets universal property in terms of functors from this category. *)
...
locale finsubset_colimit =
  F : "functor" "finiteSubsetCat.comp X" pointed_set_comp F
  for X :: "'a LC pointed_set"
  and F :: "('a LC pointed_set \<times> 'a LC pointed_set) option \<Rightarrow> 'a LC parr option" +
assumes obj_X: "Obj' X"
begin
...
locale gammaSet_as_Endofunctor =
  M : "functor" pointed_fin_set.comp pointed_set_comp M
  for
  M :: "gamma \<Rightarrow> 's LC parr option"
begin
...
definition endofunctor where
  "endofunctor = Colimit_Functoriality.colim_functor"

lemma "functor pointed_set_comp pointed_set_comp endofunctor"
  unfolding endofunctor_def
